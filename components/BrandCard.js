  ...
  return (
    <div className="brand-card">
      ...
      <style jsx>{`
        ...
        .comment-count { position:absolute; top:-7px; right:-4px; min-width:9px; height:11px; padding:0 1px; display:inline-flex; align-items:center; justify-content:center; color:#b89a7a; background:transparent; border:0; font:700 8px/1 var(--font-sans); letter-spacing:-.02em; pointer-events:none; }
